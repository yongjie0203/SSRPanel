                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="dataTables_info" role="status" aria-live="polite">共 {{$groupList->total()}} 个群发分组</div>
                            </div>
...
@section('script')
    <script type="text/javascript">
        // 添加节点分组
        function addGroup() {
            window.location.href = '{{url('marketing/addGroup')}}';
        }

        // 编辑节点分组
        function editGroup(id) {
            window.location.href = '{{url('marketing/editGroup?id=')}}' + id + '&page=' + '{{Request::get('page', 1)}}';
        }

        // 删除节点分组
        function delGroup(id) {
            layer.confirm('确定删除分组？', {icon: 2, title:'警告'}, function(index) {
                $.post("{{url('marketing/delGroup')}}", {id:id, _token:'{{csrf_token()}}'}, function(ret) {
