...
class MarketingController extends Controller
{
    ...
    public function addGroup(Request $request){
        if ($request->method() == 'POST') {
            ...
            if (!empty($t)) {
                $conditionsxml .= this-> getConditionItemXml('user_label','label_id','or',explode(",",$t));
            }
            if(!empty($l)){        
                $conditionsxml .= this-> getConditionItemXml('user','level','or',explode(",",$l));
            }
            if($u!=""){        
                $conditionsxml .= this-> getConditionItemXml('user','status','or',explode(",",$u));
            }
            $conditionsxml .= "</conditions>";
